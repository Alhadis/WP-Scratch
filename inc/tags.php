...
/** Return the text for the page's title tag. */
...
/**
 * Return the titles for the post archive being displayed
...
/** Return the title for an archive page. */
function archive_title(){
	return reset(archive_titles());
}

/** Return the subtitle/description of an archive page. */
